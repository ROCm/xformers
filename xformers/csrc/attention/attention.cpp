...
TORCH_LIBRARY_FRAGMENT(xformers, m) {
  ...
  m.def(TORCH_SELECTIVE_SCHEMA(
      ...
      "bool compute_logsumexp, int custom_mask_type, float? scale, Tensor? seqlen_k, int? window_size, Tensor? block_tables, int? page_size, int? num_kv_splits) -> (Tensor, Tensor?, int, int)"));
  m.def(TORCH_SELECTIVE_SCHEMA(
