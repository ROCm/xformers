...
static const std::vector<FmhaFwdSpecificConfig> g_qr_async_tr_load_pipeline_bf16_configs = {
    // clang format off
    //  |    B    |    M    |    N    |    Hq   |   Hkv  |    K   |   Kv  |
...
static const std::vector<FmhaFwdSpecificConfig> g_fmha_fwd_v3_pipeline_bf16_specific_configs = {
    // clang format off
